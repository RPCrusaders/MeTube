...
def main():
    ...
    result = channel.queue_declare(queue="llo", exclusive=True, durable=True)
    ...
    channel.basic_consume(queue=queue_name, on_message_callback=_consume_youtuber_requests)
